...
describe 'Usuário aceita um pedido' do
  context 'PATCH /api/v1/stores/:store_code/orders/:code/confirmed' do
    it 'com sucesso' do
      ...
      patch confirmed_api_v1_store_order_path(store.code, order.code)
      ...
      expect(json_response['order']['status']).to eq 'preparing'
      ...
      expect(Order.last.status).to eq 'preparing'
    end

    it 'não pode aceitar pedidos sem itens registrados' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
      ...
      expect(response.content_type).to include 'application/json'
      json_response = JSON.parse(response.body)
      expect(json_response['order_items']['message']).to eq 'Não é permitido a confirmação de pedidos sem itens registrados'
      expect(Order.last.status).to eq 'waiting_confirmation'
    end

    it 'não pode aceitar pedidos já confirmados' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
      ...
      expect(response.content_type).to include 'application/json'
      json_response = JSON.parse(response.body)
      expect(json_response['message']).to eq 'Status do pedido inválido para confirmação'
    end

    it 'não pode aceitar pedidos cancelados' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
    ...
    it 'não pode aceitar pedidos concluídos' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
    ...
    it 'não pode aceitar pedidos já entregues' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
    ...
    it 'falha ao ter erro interno' do
      ...
      order = store.orders.create!(name: 'Jhon', phone_number: '(11) 999998888', email: 'jhon@email.com', register_number: '701.128.250-52')
      order_item = order.order_items.create!(menu: menu, item: drink, portion: drink_portion, quantity: 1, observation: 'Ok')
      allow_any_instance_of(Order).to receive(:preparing!).and_raise(ActiveRecord::ActiveRecordError)
    ...
    it 'código do pedido deve pertencer ao Estabelecimento' do
      ...
      patch confirmed_api_v1_store_order_path(other_store.code, order.code)
