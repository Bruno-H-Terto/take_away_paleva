...
describe 'Usuário edita dados do Estabelecimento' do
  context 'Owner PATCH  /take_away_stores/:id' do
    ...
    it 'faz requisição inválida' do
      ...
      patch take_away_store_path(99999), params: { take_away_store: { trade_name: 'Pastel Dev'} }

      expect(response).to redirect_to root_path
    end
  end

  context 'Employee PATCH  /take_away_stores/:id' do
