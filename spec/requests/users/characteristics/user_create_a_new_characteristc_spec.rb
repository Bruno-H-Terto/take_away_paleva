...
describe 'Usuário cria uma nova Característica' do
  context 'Owner POST /characteristics' do
    it 'deve estar autenticado' do
      ...
      post characteristics_path, params: { characteristic: { quality_name: 'Salgado', take_away_store: store } }

      expect(response).to redirect_to new_owner_session_path
    end

    it 'só tem acesso ao cadastro no próprio restaurante' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
          register_number: '76.898.265/0001-10', phone_number: '(11) 98800-0000', street: 'Beco diagonal',
      ...
      expect(other_store.characteristics.count).to eq 1
    end
  end
