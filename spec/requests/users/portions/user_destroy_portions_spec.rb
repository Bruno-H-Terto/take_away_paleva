...
describe 'Usuário deleta uma porção' do
  context 'Owner DELETE /portions/:id' do
    it 'rota indisponível' do
      ...
      expect { delete portion_path(portion) }.to raise_error(ActionController::RoutingError)
    end
  end

  context 'Employee DELETE /portions/:id' do
    it 'rota indisponível' do
      owner = Owner.create!(name: 'Harry', surname: 'Potter', register_number: '402.793.150-58',
          email: 'quadribol@email.com', password: 'treina_dev13')
      store = owner.create_take_away_store!(trade_name: 'Grifinória', corporate_name: 'Hogwarts LTDA',
